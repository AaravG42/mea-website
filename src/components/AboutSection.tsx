...
const AboutSection = () => {
  return (
    <section className="py-20 bg-gradient-to-b from-white to-mea-lightgray">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-6 relative inline-block">
            <span className="text-mea-darkblue">What is </span>
            <span className="text-mea-gold">MEA</span>
            <span className="text-mea-darkblue">?</span>
          </h2>
